        ...
        >
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-2.5">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0f111e] border border-purple-500/40 shadow-md shadow-purple-950/40 cursor-pointer"
              >
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 text-purple-400 font-mono text-xs font-bold uppercase tracking-widest bg-purple-500/10 px-3 py-1 rounded-md border border-purple-500/30 cursor-pointer"
              >
                <Gamepad2 className="w-4 h-4 text-purple-400 animate-spin" />
              ...
              <h1 className="tracking-tight leading-tight space-y-1">
                ...
                <span className="block text-lg sm:text-2xl font-mono font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-indigo-300 to-emerald-400 min-h-[36px] flex items-center">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-3 pt-2 w-full sm:w-auto">
              <motion.a
                ...
                transition={{ type: "spring", stiffness: 400, damping: 15 }}
                href="#projects"
                className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-purple-600 via-indigo-600 to-emerald-500 hover:from-purple-500 hover:to-emerald-400 text-white font-black text-sm shadow-xl shadow-purple-950/60 transition-all flex items-center justify-center gap-2 cursor-pointer border border-purple-400/40 group"
              >
              ...
              <motion.button
                ...
                transition={{ type: "spring", stiffness: 400, damping: 15 }}
                onClick={onOpenCv}
                className="px-5 py-3.5 rounded-xl bg-[#0f111e] hover:bg-[#151829] border border-purple-500/40 hover:border-purple-300 text-slate-200 font-bold text-sm transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-md"
              >
              ...
              <div className="flex items-center gap-2">
                <motion.a
                  ...
                  className="p-3.5 rounded-xl bg-[#0f111e] hover:bg-[#151829] border border-purple-500/40 text-slate-300 hover:text-white transition-colors shadow-md"
            ...
            <motion.div
              variants={itemVariants}
              className="pt-6 border-t border-purple-500/20 w-full flex flex-wrap items-center gap-5 text-xs text-slate-300 font-mono"
            >
              <motion.div 
                whileHover={{ scale: 1.08, y: -2 }}
                transition={{ type: "spring", stiffness: 400 }}
                className="flex items-center gap-2 cursor-pointer bg-[#0f111e] px-3 py-1.5 rounded-lg border border-purple-500/30"
              >
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            ...
            <motion.div
              ...
              className="w-full rounded-2xl bg-[#0f111e] border-2 border-purple-500/40 p-6 space-y-6 shadow-2xl pro-card hud-corner"
            >
              {/* Profile Card Header */}
              <div className="flex items-center gap-4 pb-5 border-b border-purple-500/20">
                <motion.div 
                  whileHover={{ scale: 1.1, rotate: 3 }}
                  className="relative w-16 h-20 rounded-xl overflow-hidden bg-[#08090f] border-2 border-purple-500/60 shrink-0 shadow-lg cursor-pointer"
                >
                  <img
                    src={personal.avatar}
                    alt={personal.name}
                  ...
                  />
                  <span className="absolute bottom-0 inset-x-0 bg-purple-600 text-white text-[8px] font-mono font-black text-center uppercase tracking-tighter">
                    LVL 2026
                  </span>
                </motion.div>
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-xs font-mono text-purple-300 truncate">Computer Science Student</span>
              ...
              <div className="space-y-3">
                <span className="text-[10px] font-mono uppercase tracking-widest text-purple-300 font-extrabold flex items-center justify-between">
                ...
                <motion.div 
                  ...
                  className="p-3 rounded-xl bg-[#08090f] border border-purple-500/30 flex items-start gap-3 transition-colors cursor-pointer"
                >
                  <div className="p-2 rounded-lg bg-purple-500/10 text-purple-400 border border-purple-500/30 shrink-0 mt-0.5">
                ...
                <motion.button
                  ...
                  transition={{ type: "spring", stiffness: 300 }}
                  onClick={() => onOpenCert?.("bnsp-junior-web-developer")}
                  className="w-full p-3 rounded-xl bg-[#08090f] border border-purple-500/30 hover:border-amber-500/50 flex items-start gap-3 text-left transition-colors cursor-pointer"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-xl bg-[#08090f] border border-purple-500/30 hover:border-emerald-500/50 flex items-start gap-3 text-left transition-colors cursor-pointer"
                >
